...
class BodyMessageUserContentArrayOfContentPartFile(TypedDict, total=False):
    """
    Learn about [file inputs](https://main.excai.ai/docs/guides/text) for text generation.
    """
...
class BodyWebSearchOptions(TypedDict, total=False):
    ...
    Learn more about the [web search tool](https://main.excai.ai/docs/guides/tools-web-search?api-mode=chat).
    """
