...
__all__ = [
    ...
    "DataMessageContentInputAudio",
    "DataMessageContentInputAudioInputAudio",
    "DataFileSearchCall",
...
class DataMessageContentInputAudioInputAudio(BaseModel):
    data: str
...
class DataMessageContentInputAudio(BaseModel):
    input_audio: DataMessageContentInputAudioInputAudio
