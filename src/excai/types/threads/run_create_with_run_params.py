...
__all__ = [
    ...
    "ThreadMessageContentArrayOfContentPartImageFile",
    "ThreadMessageContentArrayOfContentPartImageFileImageFile",
    "ThreadMessageContentArrayOfContentPartImageURL",
    "ThreadMessageContentArrayOfContentPartImageURLImageURL",
    "ThreadMessageContentArrayOfContentPartText",
    "ThreadMessageAttachment",
    "ThreadMessageAttachmentTool",
    "ThreadMessageAttachmentToolCodeInterpreter",
...
class ThreadMessageContentArrayOfContentPartImageFileImageFile(TypedDict, total=False):
...
class ThreadMessageContentArrayOfContentPartImageFile(TypedDict, total=False):
    image_file: Required[ThreadMessageContentArrayOfContentPartImageFileImageFile]

    type: Required[Literal["image_file"]]
    """Always `image_file`."""


class ThreadMessageContentArrayOfContentPartImageURLImageURL(TypedDict, total=False):
    url: Required[str]
    """
...
class ThreadMessageContentArrayOfContentPartImageURL(TypedDict, total=False):
    image_url: Required[ThreadMessageContentArrayOfContentPartImageURLImageURL]
...
class ThreadMessageAttachmentToolCodeInterpreter(TypedDict, total=False):
...
ThreadMessageAttachmentTool: TypeAlias = Union[
    ThreadMessageAttachmentToolCodeInterpreter, ThreadMessageAttachmentToolFileSearch
]
