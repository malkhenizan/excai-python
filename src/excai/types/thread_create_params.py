...
__all__ = [
    ...
    "MessageContentArrayOfContentPartImageFile",
    "MessageContentArrayOfContentPartImageFileImageFile",
    "MessageContentArrayOfContentPartImageURL",
    "MessageContentArrayOfContentPartImageURLImageURL",
    "MessageContentArrayOfContentPartText",
    "MessageAttachment",
    "MessageAttachmentTool",
    "MessageAttachmentToolCodeInterpreter",
...
class MessageContentArrayOfContentPartImageFileImageFile(TypedDict, total=False):
...
class MessageContentArrayOfContentPartImageFile(TypedDict, total=False):
    image_file: Required[MessageContentArrayOfContentPartImageFileImageFile]

    type: Required[Literal["image_file"]]
    """Always `image_file`."""


class MessageContentArrayOfContentPartImageURLImageURL(TypedDict, total=False):
    url: Required[str]
    """
...
class MessageContentArrayOfContentPartImageURL(TypedDict, total=False):
    image_url: Required[MessageContentArrayOfContentPartImageURLImageURL]
...
class MessageAttachmentToolCodeInterpreter(TypedDict, total=False):
...
MessageAttachmentTool: TypeAlias = Union[MessageAttachmentToolCodeInterpreter, MessageAttachmentToolFileSearch]
