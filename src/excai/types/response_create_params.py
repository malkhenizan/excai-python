...
InputInputItemListMessageContent: TypeAlias = Union[InputTextContent, InputImageContent, InputFileContent]
...
ToolChoice: TypeAlias = Union[Literal["none", "auto", "required"], ToolChoiceTypesParam, ToolChoiceFunction]

Tool: TypeAlias = Union[FileSearchTool, FunctionTool, WebSearchPreviewTool, ComputerUsePreviewTool]
