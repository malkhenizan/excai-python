...
class FunctionCallOutputOutputInputTextContentParam(BaseModel):
    text: str
...
class FunctionCallOutputOutputInputImageContentParamAutoParam(BaseModel):
...
class FunctionCallOutputOutputInputFileContentParam(BaseModel):
