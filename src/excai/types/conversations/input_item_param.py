...
__all__ = [
    ...
    "FunctionCallOutput",
    "FunctionCallOutputOutput",
    "FunctionCallOutputOutputInputTextContentParam",
    "FunctionCallOutputOutputInputImageContentParamAutoParam",
    "FunctionCallOutputOutputInputFileContentParam",
    "McpApprovalResponse",
    "ItemReference",
]
...
class FunctionCallOutputOutputInputTextContentParam(TypedDict, total=False):
    text: Required[str]
...
class FunctionCallOutputOutputInputImageContentParamAutoParam(TypedDict, total=False):
...
class FunctionCallOutputOutputInputFileContentParam(TypedDict, total=False):
...
FunctionCallOutputOutput: TypeAlias = Union[
    str,
    FunctionCallOutputOutputInputTextContentParam,
    FunctionCallOutputOutputInputImageContentParamAutoParam,
    FunctionCallOutputOutputInputFileContentParam,
...
class FunctionCallOutput(TypedDict, total=False):
    ...
    output: Required[FunctionCallOutputOutput]
