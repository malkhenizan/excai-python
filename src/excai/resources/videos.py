...
from ..types import video_list_params, video_remix_params, video_create_params, video_retrieve_content_params
...
from ..types.video_remix_response import VideoRemixResponse
...
class VideosResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        model: Literal["sora-2", "sora-2-pro"] | Omit = omit,
        seconds: Literal["4", "8", "12"] | Omit = omit,
        size: Literal["720x1280", "1280x720", "1024x1792", "1792x1024"] | Omit = omit,
