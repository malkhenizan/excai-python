...
from ....types.threads.run_cancel_response import RunCancelResponse
...
class RunsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          model: The ID of the [Model](https://platform.excai.com/docs/api-reference/models) to
    ...
    def create_with_run(
        ...
        *,
        ...
        | Omit = omit,
        parallel_tool_calls: bool | Omit = omit,
        response_format: Optional[run_create_with_run_params.ResponseFormat] | Omit = omit,
        stream: Optional[bool] | Omit = omit,
        temperature: Optional[float] | Omit = omit,
        thread: run_create_with_run_params.Thread | Omit = omit,
        tool_choice: Optional[run_create_with_run_params.ToolChoice] | Omit = omit,
        ...
        return self._post(
            ...
            cast_to=RunCreateWithRunResponse,
        )
