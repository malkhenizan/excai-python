...
class RunsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        response_format: Optional[run_create_params.ResponseFormat] | Omit = omit,
        stream: Optional[bool] | Omit = omit,
        temperature: Optional[float] | Omit = omit,
        thread: run_create_params.Thread | Omit = omit,
    ...
    def create_run(
        ...
        *,
        ...
        additional_messages: Optional[Iterable[run_create_run_params.AdditionalMessage]] | Omit = omit,
        instructions: Optional[str] | Omit = omit,
        max_completion_tokens: Optional[int] | Omit = omit,
        max_prompt_tokens: Optional[int] | Omit = omit,
        metadata: Optional[Dict[str, str]] | Omit = omit,
    ...
    def submit_tool_outputs(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=RunSubmitToolOutputsResponse,
        )
    ...
    def update_run(
        ...
        *,
        ...
        return self._post(
            f"/threads/{thread_id}/runs/{run_id}",
            body=maybe_transform({"metadata": metadata}, run_update_run_params.RunUpdateRunParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RunUpdateRunResponse,
        )
...
class AsyncRunsResource(AsyncAPIResource):
    ...
    async def update_run(
        ...
        *,
        ...
        return await self._post(
            f"/threads/{thread_id}/runs/{run_id}",
            body=await async_maybe_transform({"metadata": metadata}, run_update_run_params.RunUpdateRunParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RunUpdateRunResponse,
...
class RunsResourceWithRawResponse:
    def __init__(self, runs: RunsResource) -> None:
        ...
        self.update_run = to_raw_response_wrapper(
            runs.update_run,
        )
...
class AsyncRunsResourceWithRawResponse:
    def __init__(self, runs: AsyncRunsResource) -> None:
        ...
        self.update_run = async_to_raw_response_wrapper(
            runs.update_run,
        )
...
class RunsResourceWithStreamingResponse:
    def __init__(self, runs: RunsResource) -> None:
        ...
        self.update_run = to_streamed_response_wrapper(
            runs.update_run,
        )
...
class AsyncRunsResourceWithStreamingResponse:
    def __init__(self, runs: AsyncRunsResource) -> None:
        ...
        self.update_run = async_to_streamed_response_wrapper(
            runs.update_run,
        )
