...
export class Assistants extends APIResource {
   ...
   * @example
   * ```ts
   * const assistant = await client.assistants.retrieve(
   *   'assistant_id',
   * );
   * ```
   */
   ...
   * @example
   * ```ts
   * const assistant = await client.assistants.delete(
   *   'assistant_id',
   * );
   * ```
   */
...
export interface AssistantCreateResponse {
   ...
   * IDs.
   */
  tool_resources?: AssistantCreateResponse.ToolResources | null;
...
export interface AssistantRetrieveResponse {
   ...
   * IDs.
   */
  tool_resources?: AssistantRetrieveResponse.ToolResources | null;
...
export interface AssistantUpdateResponse {
   ...
   * IDs.
   */
  tool_resources?: AssistantUpdateResponse.ToolResources | null;
