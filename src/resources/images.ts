...
export class Images extends APIResource {
   ...
   */
  createEdit(
    body: ImageCreateEditParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ImageCreateEditResponse> {
   ...
   */
  createImage(
    body: ImageCreateImageParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ImageCreateImageResponse> {
  ...
  createVariation(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<ImageCreateVariationResponse> {
    return this._client.post('/images/variations', Core.multipartFormRequestOptions({ body, ...options }));
  }
}

/**
 * Represents the content or the URL of an image generated by the EXCai API.
 */
 ...
 * The response from the image generation endpoint.
 */
export interface ImageCreateImageResponse {
  /**
   * The Unix timestamp (in seconds) of when the image was created.
   */
  created: number;
 ...
 * The response from the image generation endpoint.
 */
export interface ImageCreateVariationResponse {
  /**
   * The Unix timestamp (in seconds) of when the image was created.
   */
  created: number;
