...
export class Uploads extends APIResource {
  ...
  ): Core.APIPromise<UploadAddPartResponse> {
   ...
   */
  cancel(uploadId: string, options?: Core.RequestOptions): Core.APIPromise<UploadCancelResponse> {
  ...
  complete(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<UploadCompleteResponse> {
