...
export class Evals extends APIResource {
   ...
   * the [Evals guide](https://platform.excai.com/docs/guides/evals).
   */
   ...
   */
  list(query?: EvalListParams, options?: Core.RequestOptions): Core.APIPromise<EvalListResponse>;
  list(options?: Core.RequestOptions): Core.APIPromise<EvalListResponse>;
  list(
    query: EvalListParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<EvalListResponse> {
   ...
   */
  delete(evalId: string, options?: Core.RequestOptions): Core.APIPromise<EvalDeleteResponse> {
 ...
 */
export interface EvalGraderPython extends FineTuningAPI.GraderPython {
  /**
 ...
 */
export interface EvalGraderScoreModel extends FineTuningAPI.GraderScoreModel {
  /**
   * The threshold for the score.
   */
  pass_threshold?: number;
 ...
 */
export interface EvalGraderTextSimilarity extends FineTuningAPI.GraderTextSimilarity {
  /**
   * The threshold for the score.
   */
  pass_threshold: number;
...
export interface EvalListResponse {
   ...
   */
  data: Array<EvalListResponse.Data>;
...
export namespace EvalListResponse {
  ...
  export interface Data {
     ...
     */
    data_source_config:
      | EvalsAPI.EvalCustomDataSourceConfig
      | EvalsAPI.EvalLogsDataSourceConfig
      | EvalsAPI.EvalStoredCompletionsDataSourceConfig;
    ...
    testing_criteria: Array<
      | Shared.GraderLabelModel
      | Shared.GraderStringCheck
      | EvalsAPI.EvalGraderTextSimilarity
      | EvalsAPI.EvalGraderPython
      | EvalsAPI.EvalGraderScoreModel
    >;
  }
}
